...
import com.example.plumaFitApp.AlarmReceiver
import com.example.plumaFitApp.data.models.Notification
import com.example.plumaFitApp.databinding.FragmentNewNotificationsBinding
    ...
    private fun setListeners() {
        binding.saveButton.setOnClickListener {
            if (binding.nameEt.text.isNullOrEmpty() || binding.timeEt.text.isNullOrEmpty()) {
                ...
                findNavController().navigate(com.example.plumaFitApp.ui.main.notifications.NewNotificationsFragmentDirections.toNotification())
            }
        }
    }
