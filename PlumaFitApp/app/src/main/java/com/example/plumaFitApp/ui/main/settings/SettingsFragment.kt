...
class SettingsFragment : ToolbarFragment() {
    ...
    private fun setAdapter() {
        ...
        binding.run {
            ...
            adapter.loadData(generateMockProfessionals())
        }
    }

    fun generateMockProfessionals(): MutableList<User> {
        val professionals = mutableListOf<User>()
        val users = listOf(
            User("John Doe", "password1", "john.doe@example.com", "123456789"),
            User("Jane Smith", "password2", "jane.smith@example.com", "987654321"),
            User("Robert Johnson", "password3", "robert.johnson@example.com", "456789123")
        )
